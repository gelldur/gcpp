...
// http://en.cppreference.com/w/cpp/concept/UniformRandomBitGenerator - how to make it work with
// proper distributions only changes I made are to make a class from this algorithm and make it work
